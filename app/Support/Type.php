...
class Type
{
     ...
     * @return T
     */
    public static function instanceOf(string $class, mixed $value): object
    {
        return self::nullableInstanceOf($class, $value)
     ...
     * @return T
     */
    public static function nullableInstanceOf(string $class, mixed $value): ?object
    {
        $value = value($value);
